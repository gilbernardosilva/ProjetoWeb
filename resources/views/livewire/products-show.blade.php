...
<section class="py-5" style="background-image: url(https://cdn.discordapp.com/attachments/978618862100693004/1062759853854044231/856f31d9f475501c7552c97dbe727319.png);">
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" width="650" height="550" src="{{ asset('storage/images/' . $product->game->photos->path) }}" alt="..." /></div>
            <div class="col-md-6">
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="card align-items-left bg-dark" style="width: 18rem display: flex; align-items: left; justify-content: left; width: 1300px; height: 300px;">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item" style="background: rgb(204, 203, 203)">
                    <div class="mb-1">
                        ...
                        @if($productSeller->user->photo ==null)
                        Seller: <h7 class="small mb-1">{{ $productSeller->user->name }}</h7>
                        @else
                        <img width="50" height="50" src="{{ asset('storage/images/' . $productSeller->user->photo->path) }}" alt="..." />
                        Seller: <h7 class="small mb-1">{{ $productSeller->user->name }}</h7>
                        @endif
                    </div>
                    <div class="col-md-0 float-right">
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <a href="{{ url('/products/show/' . $product->id . '/' . $product->user->id) }}">
                        <img class="card-img-top" style="border-top-radius:1.7rem; height: 210px; display: block; margin: 0 auto; object-fit: cover;" src="{{ asset('storage/images/' . $product->game->photos->path) }}" alt="..." /></a>
                    <!-- Product details-->
